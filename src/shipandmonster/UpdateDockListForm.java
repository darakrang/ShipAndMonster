 ...
 * @author Dara
 */
public class UpdateDockListForm extends JDialog implements ActionListener,ListSelectionListener
{
    JList list;
    ...
    public void ShowDialog(ArrayList<Dock> dockList) {
        arrayListDock = dockList;
    ...
    public void loadList(ArrayList<Dock> dockList)
    {
        DefaultListModel<String> model = new DefaultListModel<String>();
        for (int i = 0; i < dockList.size(); i++) {
            model.addElement(dockList.get(i).getName());
        }
        list.setModel(model);
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (e.getActionCommand()==commandUpdate)
        {
            ...
            UpdateDockForm frm = new UpdateDockForm();
            frm.ShowDiaglog(index, arrayListDock);
            this.dispose();
        }
