...
public class OilTanker extends CargoShip{
    ...
    public OilTanker(String dataLine) {
        ...
        if (token.length > 9) {
            this.cargo = new Oil(token[9] + "," + token[10]);
        }
    }
    ...
    public String toString() {
        String string = "";
        if (this.getCargo() != null) {
            string = this.getName() + "," + this.getCountry() + "," + this.getTransponder() + "," + this.getCargoCapacity() + "," + this.getLength() + "," + this.getBeam() + "," + this.getDraft() + "," + this.getLongitude() + "," + this.getLatitude() + "," + this.getCargo().getDescription() + "," + this.getCargo().getBarrels();
        } else {
